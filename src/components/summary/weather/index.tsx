...
const WeatherSummary = () => {
  ...
  return (
    isReady && (
      <div className="fixed left-10 top-2 md:top-auto md:left-2 md:bottom-2 pr-2 bg-white rounded border-gray-300 dark:bg-gray-800 dark:border-gray-700 flex items-center">
