...
import { powerStationTagFilter } from "@/services/overpass/filters/tags";
...
export const searchPowerStationNearby = async (
  node: Coordinate,
  distance: number = 100
) => {
  ...
  const query = `nwr(around:${distance},${point})${powerStationTagFilter};out center skel;`;
